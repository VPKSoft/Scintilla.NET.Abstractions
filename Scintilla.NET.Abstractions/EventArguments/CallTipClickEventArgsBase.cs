...
public abstract class CallTipClickEventArgsBase : ScintillaEventArgs, ICallTipClickEventArgs
{
    ...
    /// </summary>
    /// <param name="scintillaApi">The Scintilla control that generated this event.</param>
